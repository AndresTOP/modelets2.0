    ...
    if ($pos === false ){
        ...
        if ($rec['nick'] !== NULL and $rec['precio'] !== NULL){
            if ($puja > $rec['precio'] ){
             ...
             <?php echo "<a href='mostrarProducto.php?id=$id'>Precio incorrecto, pruebe de nuevo por favor </a>"; ?>
        </div>
        <?php
   	    ...
   	    <div class="alert alert-success" role="alert">
             ...
             ?>
   	        ...
   	        <div class="alert alert-danger" role="alert">
             <?php echo "<a href='mostrarProducto.php?id=$id'>Precio por debajo del máximo, pruebe de nuevo por favor </a>"; ?>
        </div>
        <?php
        ...
        <?php
   	        ...
   	        <div class="alert alert-danger" role="alert">
             <?php echo "<a href='mostrarProducto.php?id=$id'>Precio incorrecto (valor negativo o carácteres incorrectos), pruebe de nuevo por favor </a>"; ?>
        </div>
        <?php
